...
bg_surface = pygame.image.load('FlappyBirdImages/background-day.png')
...
bird_downflap = pygame.transform.scale2x(pygame.image.load('FlappyBirdImages/pinkbird-downflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('FlappyBirdImages/pinkbird-upflap.png').convert_alpha())
...
pipe_surface = pygame.image.load('FlappyBirdImages/pipe-wine.png')
